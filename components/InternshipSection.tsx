...
export default function InternshipSection({ onApplyClick }: { onApplyClick: () => void }) {
  return (
    <section id="internship" className="py-24 bg-white border-t border-gray-100 relative overflow-hidden">
        {/* Background Decor */}
        <div className="absolute top-0 right-0 w-1/2 h-full bg-blue-50 skew-x-12 translate-x-20 pointer-events-none"></div>
        
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 text-left">
                <h2 className="text-sm font-bold tracking-widest text-blue-600 uppercase mb-3">Student Program</h2>
                <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">Deep Tech Research Internship</h3>
                ...
                <button onClick={onApplyClick} className="px-6 py-3 bg-transparent border border-blue-600 text-blue-600 font-bold rounded-lg hover:bg-blue-600 hover:text-white transition-all duration-300 hover:scale-105 active:scale-95">
                    Apply for Internship &rarr;
                </button>
            </div>
            <div className="w-full md:w-1/3 flex justify-center">
                <div className="w-32 h-32 bg-white rounded-full flex items-center justify-center border border-gray-200 shadow-2xl relative animate-float">
